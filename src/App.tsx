...
const App = () => {
      ...
      useLifecycle(() => {
        const setup = async () => {
          ...
          providerRegistry.registerOutputServiceProvider("Web Speech", WebSpeechOutputServiceProvider);
      ...
      if (appState === AppState.Loading) {
        ...
        return <BlockingErrorMessage header="error" message={appError} onClose={handleErrorClose} />
      } else {
