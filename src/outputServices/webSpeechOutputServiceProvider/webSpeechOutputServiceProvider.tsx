...
export default class WebSpeechOutputServiceProvider extends OutputServiceProvider {
    ...
    constructor(outputSettings: any = null) {
        ...
        if (!defaultVoice) {
            throw new Error(
                "Tried to initialize WebSpeechOutputServiceProvider with no voices loaded.",
            );
        }
        if (!outputSettings) {
            this.outputSettings = {
    ...
    ServiceSettingsComponent(): any {
        return (
            <p>
                No service connection settings available; see settings tab for
    ...
    OutputSettingsComponent({ settings }: { settings: any }): any {
        ...
        return (
            <form>
                ...
                >
                    {Object.keys(WebSpeechOutputServiceProvider.voices).map(
                        (name: string) => (
